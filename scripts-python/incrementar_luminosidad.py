...
if response and "result" in response:
    ...
    # Incrementar el brillo en 10%
    new_brightness = min(current_brightness + 10, 100)  # Máximo 100
    increase_brightness_command = {
        "id": 2,
        "method": "set_bright",
        "params": [new_brightness, "smooth", 500]
    }
    send_command(FOCO_IP, FOCO_PORT, increase_brightness_command)
    print(f"[LOG] Brillo incrementado a: {new_brightness}")
else:
